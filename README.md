...
This is the default <b>coloring algorithm</b>, which is the standard <i>escape time coloring algorithm</i>. You can see that is is <b>dynamic</b>, meaning that the colors kind of "flow" towards the Mandelbrot Set:
