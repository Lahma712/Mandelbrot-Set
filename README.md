...
The Mandelbrot Set is defined as the set of complex numbers <b><i>c</i></b> for which the function <b><i>z<sub><i>n+1</i></sub> = z<sub>n</sub><sup>2</sup> + c</i></b> 
remains bounded when iterated from <b><i>z = 0</b></i>.
